...
<script>
  ...
  import { getRoleList, editArchiveManagement, getAddress, getGovernMentalDisordersPage, deleteGovernMentalDisorders } from '@/api/manage'
  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        loadData: (parameter) => {
          ...
          return getGovernMentalDisordersPage(requestParameters).then((res) => {
            console.log(res)
            return res.result
          })
        },
    ...
    methods: {
      ...
      handleDel (record) {
        ...
        var id = record.id
        var arr = [id]
        return deleteGovernMentalDisorders(arr).then((res) => {
          console.log(res)
          if (res.code === 200) {
