          ...
          <a-row>
            ...
            >
              <a-form-item label="家庭经济状况">
                <a-input
                  v-decorator="['familyEconomicStatus']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="监护人联系类型">
                <a-select
                  v-decorator="['guardianContactType']"
                  placeholder="请选择"
                  default-value="0"
                >
                  <a-select-option value="0">无</a-select-option>
            ...
            >
              <a-form-item label="监护人联系方式">
                <a-input
                  v-decorator="['guardianContactInformation']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="目前诊断类型">
                <a-select
                  v-decorator="['currentDiagnosisType']"
                  placeholder="请选择"
                  default-value="0"
                >
            ...
            >
              <a-form-item label="有无肇事肇祸史">
                <a-select
                  v-decorator="['causingTroubleHistory']"
                  placeholder="请选择"
                  default-value="0"
                >
                  <a-select-option value="0">无</a-select-option>
            ...
            >
              <a-form-item label="目前危险性评估等级">
                <a-select
                  v-decorator="['currentRiskAssessmentLevel']"
                  placeholder="请选择"
                  default-value="0"
                >
            ...
            >
              <a-form-item label="治疗医院名称">
                <a-input
                  v-decorator="['treatmentHospitalName']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="实施住院治疗原因">
                <a-input
                  v-decorator="['hospitalizationReasons']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="接收康复训练机构名称">
                <a-input
                  v-decorator="['rehabilitationTrainingInstitutions']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="参与管理人员">
                <a-input
                  v-decorator="['participatingManagers']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
...
import { searchArchiveManagement, editArchiveManagement, editGovernMentalDisorders } from '@/api/manage'
// 表单字段
const fields = [
  // 'description',
  'id',
...
const field = [
 'assistance',
  ...
  'rehabilitationTrainingInstitutions',
  'hospitalizationReasons',
  'treatmentHospitalName',
  'treatment',
  'currentRiskAssessmentLevel',
  'lastIncidentDate',
  'accidentsNumber',
  'causingTroubleHistory',
    ...
    submitSpecial () {
      ...
      form.validateFields((errors, values) => {
        ...
        if (!errors) {
          ...
          return editGovernMentalDisorders(data).then((res) => {
            // 重置表单数据
            form.resetFields()
            form1.resetFields()
            if (res.code === 200) {
