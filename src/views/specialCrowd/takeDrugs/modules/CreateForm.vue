          ...
          <a-row>
            ...
            >
              <a-form-item label="初次发现日期">
                <a-date-picker
                  v-decorator="['firstDiscoveryDate']"
                  style="width: 100%"
                  placeholder="请输入"
                />
              </a-form-item>
            ...
            >
              <a-form-item label="管控人联系类型">
                <a-select
                  v-decorator="['controllerContactType']"
                  placeholder="请选择"
                  default-value="0"
                >
                  <a-select-option value="0">无</a-select-option>
            ...
            >
              <a-form-item label="管控人联系方式">
                <a-input
                  v-decorator="['controllerContactInformation']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="吸毒后果">
                <a-input
                  v-decorator="['drugAbuseConsequences']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
...
import { searchArchiveManagement, editArchiveManagement, editGovernDrugAddicts } from '@/api/manage'
// 表单字段
const fields = [
  'id',
  'idCard',
    ...
    submitSpecial () {
      ...
      form.validateFields((errors, values) => {
        ...
        if (!errors) {
          ...
          return editGovernDrugAddicts(data).then((res) => {
            // 重置表单数据
            form.resetFields()
            form1.resetFields()
            if (res.code === 200) {
