        ...
        <a-card title="信访人员信息">
          <a-row>
            <a-col
              ...
              :sm="24"
            >
              <a-form-item label="诉求内容">
                <a-input
                  v-decorator="['appealContent']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            <a-col
              ...
              :sm="24"
            >
              <a-form-item label="单位或住址">
                <a-input
                  v-decorator="['unitOrAddress']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            <a-col
              ...
              :sm="24"
            >
              <a-form-item label="包案领导">
                <a-input
                  v-decorator="['contractLeader']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            <a-col
              ...
              :sm="24"
            >
              <a-form-item label="稳控责任人">
                <a-input
                  v-decorator="['chargeStabilityControl']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            <a-col
              ...
              :sm="24"
            >
              <a-form-item label="稳控责任人电话">
                <a-input
                  v-decorator="['chargeStabilityControlTelephone']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
...
import { searchArchiveManagement, editArchiveManagement, editGovernKeyPetitioners } from '@/api/manage'
// 表单字段
const fields = [
  // 'description',
  'id',
...
const field = [
  'chargeStabilityControlTelephone',
  'chargeStabilityControl',
  'contractLeader',
  'responsibleUnit',
  'personLiable',
  'unitOrAddress',
    ...
    submitSpecial () {
      ...
      form.validateFields((errors, values) => {
        ...
        if (!errors) {
          ...
          return editGovernKeyPetitioners(data).then((res) => {
            // 重置表单数据
            form.resetFields()
            form1.resetFields()
            if (res.code === 200) {
