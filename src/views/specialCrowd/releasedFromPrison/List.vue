...
<script>
  ...
  import { getRoleList, editArchiveManagement, getAddress, getGovernReleasePrisoners, deleteGovernReleasePrisoners } from '@/api/manage'
  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        loadData: (parameter) => {
          ...
          return getGovernReleasePrisoners(requestParameters).then((res) => {
            console.log(res)
            return res.result
          })
        },
    ...
    methods: {
      ...
      handleDel (record) {
        ...
        var id = record.id
        var arr = [id]
        return deleteGovernReleasePrisoners(arr).then((res) => {
          console.log(res)
          if (res.code === 200) {
