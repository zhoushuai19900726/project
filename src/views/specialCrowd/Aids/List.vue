          ...
          <a-row>
            ...
            <template v-if="advanced">
              ...
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="感染途径">
                  <a-input
                    v-model="queryParam.infectionRoute"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="是否有违法犯罪史">
                  <a-select
                    v-model="queryParam.crimeHistory"
                    placeholder="请选择"
                    default-value="0"
                  >
              ...
              >
                <a-form-item label="关注类型">
                  <a-select
                    v-model="queryParam.attentionType"
                    placeholder="请选择"
                    default-value="0"
                  >
                    <a-select-option value="0">无</a-select-option>
              ...
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="收治情况">
                  <a-input
                    v-model="queryParam.treatmentSituation"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="收治机构名称">
                  <a-input
                    v-model="queryParam.institutionName"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
...
<script>
  ...
  import { getRoleList, editArchiveManagement, getAddress, getGovernAidsRisk, deleteGovernAidsRisk } from '@/api/manage'
  ...
  const columns = [
    ...
    },
    {
      ...
      scopedSlots: { customRender: 'infectionRoute' }
    },
    {
      title: '是否有违法犯罪史',
      dataIndex: 'crimeHistory',
      scopedSlots: { customRender: 'crimeHistory' }
    },
    {
      title: '违法犯罪情况',
    ...
    {
      title: '关注类型',
      dataIndex: 'attentionType',
      scopedSlots: { customRender: 'attentionType' }
    },
    {
      title: '帮扶情况',
    ...
    },
    {
      ...
      scopedSlots: { customRender: 'treatmentSituation' }
    },
    {
      title: '收治机构名称',
      dataIndex: 'institutionName',
      scopedSlots: { customRender: 'institutionName' }
    },
    {
      title: '操作',
      dataIndex: 'action',
  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        loadData: (parameter) => {
          ...
          return getGovernAidsRisk(requestParameters).then((res) => {
            console.log(res)
            return res.result
          })
        },
    ...
    methods: {
      ...
      handleDel (record) {
        ...
        var id = record.id
        var arr = [id]
        return deleteGovernAidsRisk(arr).then((res) => {
          console.log(res)
          if (res.code === 200) {
