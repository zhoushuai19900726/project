          ...
          <a-row>
            ...
            >
              <a-form-item label="收治情况">
                <a-input
                  v-decorator="['treatmentSituation']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
...
import { searchArchiveManagement, editArchiveManagement, editGovernAidsRisk } from '@/api/manage'
// 表单字段
const fields = [
  // 'description',
  'id',
    ...
    submitSpecial () {
      ...
      form.validateFields((errors, values) => {
        ...
        if (!errors) {
          ...
          return editGovernAidsRisk(data).then((res) => {
            // 重置表单数据
            form.resetFields()
            form1.resetFields()
            if (res.code === 200) {
