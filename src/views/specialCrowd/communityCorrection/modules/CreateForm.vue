          ...
          <a-row>
            ...
            >
              <a-form-item label="社区矫正人员编号">
                <a-input
                  v-decorator="['communityCorrectionNumber']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="原羁押场所">
                <a-input
                  v-decorator="['originalCustodyPlace']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="矫正类别">
                <a-select
                  v-decorator="['correctionCategory']"
                  placeholder="请选择"
                  default-value="0"
                >
            ...
            >
              <a-form-item label="是否建立矫正小组">
                <a-select
                  v-decorator="['correctiveTeamEstablished']"
                  placeholder="请选择"
                  default-value="0"
                >
                  <a-select-option value="0">是</a-select-option>
            ...
            >
              <a-form-item label="矫正小组人员组成情况">
                <a-input
                  v-decorator="['correctionTeamComposition']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="矫正解除(终止)类型">
                <a-select
                  v-decorator="['correctionReleaseType']"
                  placeholder="请选择"
                  default-value="0"
                >
                  <a-select-option value="0">是</a-select-option>
            ...
            >
              <a-form-item label="检查监督托管情况">
                <a-input
                  v-decorator="['checkSuperviseTrusteeship']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="检查监督漏管情况">
                <a-input
                  v-decorator="['inspectSuperviseLeakage']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="刑罚变更执行情况">
                <a-input
                  v-decorator="['penaltyChangeExecution']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
...
import { searchArchiveManagement, editArchiveManagement, editgovernCommunityCorrectionStaff } from '@/api/manage'
// 表单字段
const fields = [
  // 'description',
  'id',
...
const field = [
  'recidivismName',
  'recidivism',
  'penaltyChangeExecution',
  'rewardPunishment',
  'leakageCorrection',
  'inspectSuperviseLeakage',
  'leakageCauses',
  'leakage',
  'custodyCorrection',
  'checkSuperviseTrusteeship',
  'trusteeshipReason',
  'custody',
  'correctionReleaseType',
  'correctionTeamComposition',
  'correctiveTeamEstablished',
  'threeSteps',
  'recidivist',
  'fourHistories',
  'receivingMode',
  ...
  'originalSentenceStartingDate',
  'originalSentence',
  'specificCharges',
  'casesType',
  'correctionCategory',
  'originalCustodyPlace',
  'communityCorrectionNumber'
]
    ...
    submitSpecial () {
      ...
      form.validateFields((errors, values) => {
        ...
        if (!errors) {
          ...
          return editgovernCommunityCorrectionStaff(data).then((res) => {
            // 重置表单数据
            form.resetFields()
            if (res.code === 200) {
              form.resetFields()
