...
<script>
  ...
  import { getRoleList, getAddress, editArchiveManagement, getGovernCommunityCorrectionStaff, deletegovernCommunityCorrectionStaff } from '@/api/manage'
    ...
    data () {
      ...
      return {
        ...
        loadData: (parameter) => {
          ...
          return getGovernCommunityCorrectionStaff(requestParameters).then((res) => {
            console.log(res)
            return res.result
          })
        },
