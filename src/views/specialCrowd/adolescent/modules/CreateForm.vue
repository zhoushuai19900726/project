          ...
          <a-row>
            ...
            >
              <a-form-item label="与监护人关系">
                <a-select
                  v-decorator="['guardianRelationship']"
                  placeholder="请选择"
                  default-value="0"
                >
                  <a-select-option value="0">无</a-select-option>
            ...
            >
              <a-form-item label="监护人居住详址">
                <a-input
                  v-decorator="['guardianResidenceAddress']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="违法犯罪情况">
                <a-input
                  v-decorator="['illegalCriminalSituation']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="帮扶人联系类型">
                <a-select
                  v-decorator="['helpersContactType']"
                  placeholder="请选择"
                  default-value="0"
                >
                  <a-select-option value="0">无</a-select-option>
            ...
            >
              <a-form-item label="帮扶人联系方式">
                <a-input
                  v-decorator="['helpersContactInformation']"
                  style="width: 100%"
                />
              </a-form-item>
            </a-col>
...
import { searchArchiveManagement, editArchiveManagement, editGovernKeyYouth } from '@/api/manage'
// 表单字段
const fields = [
  // 'description',
  'id',
...
const field = [
  ...
  'illegalCriminal',
  'illegalCriminalSituation',
  'helperName',
  'helpersContactType',
  'helpersContactInformation',
  'helpMeans',
  'assistance'
]
    ...
    submitSpecial () {
      ...
      form.validateFields((errors, values) => {
        ...
        if (!errors) {
          ...
          return editGovernKeyYouth(data).then((res) => {
            // 重置表单数据
            form.resetFields()
            form1.resetFields()
            if (res.code === 200) {
