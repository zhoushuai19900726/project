...
<script>
  ...
  import { getRoleList, editArchiveManagement, getAddress, getGovernKeyYouth, deleteGovernKeyYouth } from '@/api/manage'
    ...
    data () {
      ...
      return {
        ...
        loadData: (parameter) => {
          ...
          return getGovernKeyYouth(requestParameters).then((res) => {
            console.log(res)
            return res.result
          })
        },
