...
export default {
  ...
  data () {
    ...
    return {
      ...
      loadData: (parameter) => {
        ...
        return getRegisteredPopulation(requestParameters).then((res) => {
          console.log(res)
          return res.result
        })
      },
  ...
  methods: {
    ...
    handleEdit (record) {
      ...
      // console.log(record.governRealPopulation.nativePlaces, record.governRealPopulation.placeDomiciles, record.governRealPopulation.currentResidences)
      // 删除nativePlace等字段 防止和createform中的有冲突
      delete record.governRealPopulation.nativePlace
      delete record.governRealPopulation.placeDomicile
      delete record.governRealPopulation.currentResidence
      console.log(record)
