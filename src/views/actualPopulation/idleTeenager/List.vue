          ...
          <a-row>
            ...
            <template v-if="advanced">
              ...
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="是否有不良行为">
                  <a-select
                    v-model="queryParam.badBehavior"
                    placeholder="请选择"
                    default-value="0"
                  >
              ...
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="是否有违法犯罪经历">
                  <a-select
                    v-model="queryParam.criminalExperience"
                    placeholder="请选择"
                    default-value="0"
                  >
                    <a-select-option value="0">否</a-select-option>
...
import { getIdleYouth } from '@/api/actualPopulation'
...
const columns = [
  ...
  {
    title: '学习状况',
    dataIndex: 'learningSituation',
    scopedSlots: { customRender: 'learningSituation' }
  },
  {
    title: '就业状况',
  ...
  },
  {
    ...
    scopedSlots: { customRender: 'badBehavior' }
  },
  {
    title: '是否有违法犯罪经历',
    dataIndex: 'criminalExperience',
    scopedSlots: { customRender: 'criminalExperience' }
  },
  {
    title: '操作',
    dataIndex: 'action',
  ...
  data () {
    ...
    return {
      ...
      loadData: (parameter) => {
        ...
        return getIdleYouth(requestParameters).then((res) => {
          console.log(res)
          return res.result
        })
      },
