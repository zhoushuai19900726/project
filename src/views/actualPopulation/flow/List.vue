            ...
            <template v-if="advanced">
              ...
              >
                <a-form-item label="证件号码">
                  <a-input-number
                    v-model="queryParam.identificationNumber"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
              ...
              >
                <a-form-item label="登记日期">
                  <a-date-picker
                    v-model="queryParam.registrationDate"
                    style="width: 100%"
                    placeholder="请输入登记日期"
                  />
                </a-form-item>
              ...
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="证件到期日期">
                  <a-date-picker
                    v-model="queryParam.certificateExpirationDate"
                    style="width: 100%"
                    placeholder="请输入到期日期"
                  />
                </a-form-item>
              ...
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="住所类型">
                  <a-select
                    v-model="queryParam.residenceType"
                    placeholder="请选择"
                    default-value="0"
                  >
                    <a-select-option value="0">民宿</a-select-option>
                    <a-select-option value="1">定居</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col
              ...
              >
                <a-form-item label="是否重点关注人员">
                  <a-select
                    v-model="queryParam.focusOnPeople"
                    placeholder="请选择"
                    default-value="0"
                  >
...
import { getFloatingPopulation, deleteFloatingPopulation } from '@/api/actualPopulation'
...
export default {
  ...
  data () {
    ...
    return {
      ...
      loadData: (parameter) => {
        ...
        return getFloatingPopulation(requestParameters).then((res) => {
          console.log(res)
          return res.result
        })
      },
  ...
  methods: {
    ...
    handleDel (record) {
      ...
      var id = record.id
      var arr = [id]
      return deleteFloatingPopulation(arr).then((res) => {
        console.log(res)
        if (res.code === 200) {
