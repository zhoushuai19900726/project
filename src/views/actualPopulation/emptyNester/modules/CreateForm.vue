          ...
          <a-row>
            ...
            >
              <a-form-item label="是否享有医保">
                <a-select
                  placeholder="请选择"
                  :disabled="openType === 2"
                  v-decorator="['medicalInsuranceAvailable']"
                >
            ...
            >
              <a-form-item label="医保状况">
                <a-input
                  v-decorator="['medicalInsuranceStatus']"
                  placeholder="请输入"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="对社区服务有何需求">
                <a-input
                  v-decorator="['communityServiceDemand']"
                  placeholder="请输入"
                />
              </a-form-item>
            </a-col>
...
import { editEmptyNesterPage } from '@/api/actualPopulation'
// 表单字段
const fields = [
  // 'description',
  'id',
    ...
    submitSpecial () {
      ...
      form.validateFields((errors, values) => {
        ...
        if (!errors) {
          ...
          return editEmptyNesterPage(data).then((res) => {
            // 重置表单数据
            form.resetFields()
            if (res.code === 200) {
              form.resetFields()
