          ...
          <a-row>
            ...
            <template v-if="advanced">
              ...
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="代养情况">
                  <a-input
                    v-model="queryParam.surrogateCare"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="银行存折账号">
                  <a-input
                    v-model="queryParam.bankPassbookAccount"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
              ...
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="医疗费">
                  <a-input
                    v-model="queryParam.medicalExpenses"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
              ...
              >
                <a-form-item label="服务费">
                  <a-input
                    v-model="queryParam.serviceCharge"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="补助合计">
                  <a-input
                    v-model="queryParam.totalSubsidy"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
...
},
{
  ...
  scopedSlots: { customRender: 'surrogateCare' }
},
{
  title: '银行存折账号',
  dataIndex: 'bankPassbookAccount',
  scopedSlots: { customRender: 'bankPassbookAccount' }
},
{
  title: '餐补',
  dataIndex: 'makeUpMeal',
  scopedSlots: { customRender: 'makeUpMeal' }
},
{
  title: '医疗费',
  dataIndex: 'medicalExpenses',
  scopedSlots: { customRender: 'medicalExpenses' }
},
{
  title: '服务费',
...
},
{
  ...
  scopedSlots: { customRender: 'totalSubsidy' }
},
{
  title: '操作',
  dataIndex: 'action',
...
export default {
  ...
  data () {
    ...
    return {
      ...
      loadData: (parameter) => {
        ...
        return getThreeNonElderly(requestParameters).then((res) => {
          console.log(res)
          return res.result
        })
      },
  ...
  methods: {
    ...
    handleDel (record) {
      ...
      var arr = [id]
      console.log(arr)
      return deleteThreeNonElderly(arr).then((res) => {
        console.log(res)
        if (res.code === 200) {
