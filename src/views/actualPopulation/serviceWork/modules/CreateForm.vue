          ...
          <a-row>
            ...
            >
              <a-form-item label="就业方向">
                <a-input
                  v-decorator="['employmentDirection']"
                  placeholder="请输入"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="失业原因">
                <a-input
                  v-decorator="['unemploymentReasons']"
                  placeholder="请输入"
                />
              </a-form-item>
            </a-col>
            ...
            >
              <a-form-item label="人员类型">
                <a-select
                  placeholder="请选择"
                  :disabled="openType === 2"
                  v-decorator="['personnelType', {rules: [{required: true, message: '请输入'}]}]"
                >
                  <a-select-option value="0">无</a-select-option>
                </a-select>
              </a-form-item>
            ...
            >
              <a-form-item label="有无就业愿望">
                <a-select
                  placeholder="请选择"
                  :disabled="openType === 2"
                  v-decorator="['employmentDesire', {rules: [{required: true, message: '请输入'}]}]"
                >
                  <a-select-option value="0">无</a-select-option>
                </a-select>
              </a-form-item>
...
import { editEmploymentServices } from '@/api/actualPopulation'
// 表单字段
const fields = [
  // 'description',
  'id',
    ...
    submitSpecial () {
      ...
      form.validateFields((errors, values) => {
        ...
        if (!errors) {
          ...
          return editEmploymentServices(data).then((res) => {
            // 重置表单数据
            form.resetFields()
            if (res.code === 200) {
              form.resetFields()
