            ...
            <template v-if="advanced">
              ...
              >
                <a-form-item label="外文姓">
                  <a-input
                    v-model="queryParam.foreignSurname"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
              ...
              >
                <a-form-item label="外文名">
                  <a-input
                    v-model="queryParam.foreignName"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
              ...
              >
                <a-form-item label="国籍(地区)">
                  <a-select
                    v-model="queryParam.nationality"
                    placeholder="请选择"
                    default-value="0"
                  >
                    <a-select-option
              ...
              >
                <a-form-item label="来华目的">
                  <a-input
                    v-model="queryParam.toChinaPurpose"
                    style="width: 100%"
                  />
                </a-form-item>
              </a-col>
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="抵达日期">
                  <a-date-picker
                    v-model="queryParam.arrivalDate"
                    style="width: 100%"
                    placeholder="请输入出生日期"
                  />
                </a-form-item>
              ...
              <a-col
                ...
                :sm="24"
              >
                <a-form-item label="预计离开日期">
                  <a-date-picker
                    v-model="queryParam.expectedDepartureDate"
                    style="width: 100%"
                    placeholder="请输入出生日期"
                  />
                </a-form-item>
...
},
{
  ...
  scopedSlots: { customRender: 'foreignSurname' }
},
{
  title: '外文名',
  dataIndex: 'foreignName',
  scopedSlots: { customRender: 'foreignName' }
},
{
  title: '国籍(地区)',
...
},
{
  ...
  scopedSlots: { customRender: 'toChinaPurpose' }
},
{
  title: '抵达日期',
...
},
{
  ...
  scopedSlots: { customRender: 'expectedDepartureDate' }
},
{
  title: '操作',
  dataIndex: 'action',
...
export default {
  ...
  data () {
    ...
    return {
      ...
      loadData: (parameter) => {
        ...
        return getOverseasPersonnel(requestParameters).then((res) => {
          console.log(res)
          return res.result
        })
      },
  ...
  methods: {
    ...
    handleDel (record) {
      ...
      var id = record.id
      var arr = [id]
      return deleteOverseasPersonnel(arr).then((res) => {
        console.log(res)
        if (res.code === 200) {
